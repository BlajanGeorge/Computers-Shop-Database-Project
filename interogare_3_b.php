...
$sql = "SELECT MODEL,VITEZA,RAM,HD,ECRAN FROM tabela_laptop where ecran=15.6 order by viteza desc,hd desc";
$result= $conn-> query($sql);
if($result-> num_rows > 0){
while($row = $result-> fetch_assoc()){
echo "<tr><td>".$row["MODEL"]."</td><td>".$row["VITEZA"]."</td><td>".$row["RAM"]."</td><td>".$row["HD"]."</td><td>".$row["ECRAN"]."</td></tr>";
}
echo "</table>";
}
else
...
<div class="cerinta">
Să se găsească detaliile laptopurilor cu ecran 15,6'' ordonat descrescător după viteză și descrescător după hd.
</div>
</body>
</html>