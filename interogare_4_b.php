...
$sql = "select a.model AS 'model1' ,b.model AS 'model2'
from tabela_produs a inner join tabela_produs b ON
a.FABRICANT=b.FABRICANT
where a.tip like 'PC' and b.tip like 'PC' and a.model!=b.model and a.model<b.model";
$result= $conn-> query($sql); 
if($result-> num_rows > 0){
while($row = $result-> fetch_assoc()){
echo "<tr><td>".$row["model1"]."</td><td>".$row["model2"]."</td></tr>";
}
echo "</table>";
}
else
...
<div class="cerinta">
Să se găsească perechi de modele (model1, model2) de pc-uri cu condiția să fie produse de același fabricant. O pereche este unică în rezultat.
</div>
</body>
</html>