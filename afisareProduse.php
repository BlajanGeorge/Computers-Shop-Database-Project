...
$sql = "SELECT MODEL,FABRICANT,TIP,PRET,moneda FROM tabela_produs";
$result= $conn-> query($sql);
if($result-> num_rows > 0){
while($row = $result-> fetch_assoc()){
echo "<tr><td>".$row["MODEL"]."</td><td>".$row["FABRICANT"]."</td><td>".$row["TIP"]."</td><td>".$row["PRET"]."</td><td>".$row["moneda"]."</td></tr>";
}
echo "</table>";
}
else
