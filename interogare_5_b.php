  ...
  <div class="dropdown">
   ...
   <a href="insertImprimanta.php">Insert</a>
      <a href="deleteImprimanta.php">Delete</a>
	   <a href="afisareImprimante.php">Home</a>
    </div>
  </div> 
  </div>
</div>  
...
echo "<tr><td>".$row["MODEL"]."</td><td>".$row["TIP"]."</td></tr>";
}
echo "</table>";
}
else
...
<div class="cerinta">
Să se găsească imprimantele care au același preț ca și imprimanta ce are modelul 123.
</div>
</body>
</html>