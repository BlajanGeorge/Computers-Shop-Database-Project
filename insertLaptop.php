...
$query = "INSERT INTO tabela_laptop (MODEL, VITEZA, RAM, HD, ECRAN) VALUES ({$Model}, {$Viteza}, {$Ram},{$Hdd},{$Ecran})";
...
<label>Display:<input type="float" name="ECRAN" /><label>

</fieldset>
<br />
<input type="submit" name="submit" value="add new Laptop" class="add-button"/>
</form>
</div>
