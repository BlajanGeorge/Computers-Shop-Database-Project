...
$result= $conn-> query("call interogare_6_b()");
if($result-> num_rows > 0){
while($row = $result-> fetch_assoc()){
echo "<tr><td>".$row["TIP"]."</td><td>".$row["Pret mediu"]."</td></tr>";
}
echo "</table>";
}
else
...
<div class="cerinta">
Să se găsească prețul mediu al imprimantelor în funcție de tip.
</div>
</body>
</html>